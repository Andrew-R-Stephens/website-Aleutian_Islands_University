    ...
    return (
        <Fragment>
            <div style={{margin:"auto"}}>
                ...
                <div style={{display:"flex", marginTop:32, marginBottom:32}}>
                    {
                        userStoreRole === AuthRole.Primary_Administrator ?
                            <div className={'page-bubble-wrapper page-bubble'} onClick={() => navigate('./../admin-playground')}>
                    ...
                    <div className={'page-bubble-wrapper page-bubble'} onClick={()=>navigate('./../master-schedule', {state:{adminManagement:true}})}>
                ...
                <div style={{display:"flex", marginTop:32, marginBottom:32}}>
                    <div className={'page-bubble-wrapper page-bubble'} onClick={()=>navigate('./../advisement')}>
                    ...
                    <div className={'page-bubble-wrapper page-bubble'} onClick={()=>navigate('./../manage-users')}>
                ...
                </div>
                {
                    userStoreRole === AuthRole.Primary_Administrator ?
                        <div style={{display:"flex", marginTop:32, marginBottom:32}}>
                            <div className={'page-bubble-wrapper page-bubble'} onClick={()=>navigate('./../reset-password')}>
