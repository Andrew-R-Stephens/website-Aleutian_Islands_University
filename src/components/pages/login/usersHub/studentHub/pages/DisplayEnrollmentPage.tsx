...
import EditEnrollmentPage from "./EditEnrollmentPage";
...
function DisplayEnrollmentPage(props:any) {
    ...
    function displayEnrollment() {
        return (
            <Fragment>
                ...
                <EditEnrollmentPage targetUID={targetUID} targetRole={targetRole} godRole={godRole}/>
            </Fragment>
        );
    }
...
export default DisplayEnrollmentPage;