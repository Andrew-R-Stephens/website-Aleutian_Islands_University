    ...
    return <Fragment>
        ...
        <div  className={'bubbles-container'}>
            <div style={{display:"flex", marginTop:32, marginBottom:32}}>
                <div className={'page-bubble-wrapper page-bubble'} onClick={()=>navigate('./../semester-grades')}>
                ...
                <div className={'page-bubble-wrapper page-bubble'} onClick={()=>navigate('./../degree-audit')}>
                    <div className={'icon-degree-audit'}/>
                    <label className={'page-bubble-label'}>Degree Audit</label>
                    <div className={'page-bubble-description'}></div>
                </div>
                <div className={'page-bubble-wrapper page-bubble'} onClick={()=>navigate('./../unofficial-transcript')}>
